...
public class PendingEcomPickingList extends Fragment implements View.OnClickListener {

    private static final String classCode = "API_FRAG_PENDING ECOM PACKING";
    private View rootView;

    private Button btnCancel;
    private RecyclerView rvEcomPickPendingList;
    ...
    private String vlpdId = null, vlpdNo = null,loc = null, sku = null, desc=null,reqQty = null,
            balQty = null,barcode = null, ean = null,qty = null,userId = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (NetworkUtils.isInternetAvailable(getContext())) {
            rootView = inflater.inflate(R.layout.ecom_pending_pick, container, false);
            loadFormControls();
        } else {
    ...
    public void loadFormControls() {
        ...
        rvEcomPickPendingList = (RecyclerView) rootView.findViewById(R.id.rvEcomPickPendingList);
        rvEcomPickPendingList.setHasFixedSize(true);

        linearLayoutManager = new LinearLayoutManager(getContext());

        // use a linear layout manager
        rvEcomPickPendingList.setLayoutManager(linearLayoutManager);
    ...
    public void goBack() {
        ...
        if (materialType == "HU") {
            ...
            EcomPickFragment ecomPickFragmentHH = new EcomPickFragment();
            ecomPickFragmentHH.setArguments(bundle);
            FragmentUtils.replaceFragmentWithBackStack(getActivity(), R.id.container_body, ecomPickFragmentHH);
            return;
        } else {
                    ...
                    public void onResponse(Call<String> call, Response<String> response) {
                        ...
                        try {
                            ...
                            core = gson.fromJson(response.body().toString(), WMSCoreMessage.class);
                                ...
                                rvEcomPickPendingList.setAdapter(pendingOutboundListAdapter);
                                ProgressDialogUtils.closeProgressDialog();
    ...
    public void onResume() {
        ...
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(getString(R.string.title_activity_ecom_pendingPicking));
    }
}
