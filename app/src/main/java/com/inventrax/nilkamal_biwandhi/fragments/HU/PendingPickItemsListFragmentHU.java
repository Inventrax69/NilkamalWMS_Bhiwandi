...
public class PendingPickItemsListFragmentHU extends Fragment implements View.OnClickListener {

    private static final String classCode = "API_FRAG_PENDING PICK ITEMS";
    ...
    private String loc = null, sku = null, desc=null,reqQty = null,
            balQty = null,barcode = null, pallet = null,qty = null,Referenceno=null,Box=null,dock=null,batchno,vlpdId=null,CaseNo=null;
    Bundle bundle;
    ...
    public void goBack() {
        ...
        if (materialType == "HU") {
            ...
            PickFragmentHU pickFragmentHU = new PickFragmentHU();
            pickFragmentHU.setArguments(bundle);
            FragmentUtils.replaceFragmentWithBackStack(getActivity(), R.id.container_body, pickFragmentHU);
            return;
        } else {
    ...
    public void onResume() {
        ...
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(getString(R.string.title_activity_pending_pickitem));
    }
}