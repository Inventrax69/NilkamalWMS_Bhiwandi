...
public class PendingSkuToSkuFragmentHU extends Fragment implements View.OnClickListener {
    ...
    public void goBack() {
        ...
        if (materialType == "HU") {
            ...
            SkuToSkuFragment skuToSkuFragment = new SkuToSkuFragment();
            skuToSkuFragment.setArguments(bundle);
            FragmentUtils.replaceFragmentWithBackStack(getActivity(), R.id.container_body, skuToSkuFragment);
            return;
        } else {
