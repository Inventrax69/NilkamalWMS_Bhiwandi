...
import com.inventrax.nilkamal_biwandhi.adapters.PendingOutboundListAdapter;
...
import com.inventrax.nilkamal_biwandhi.pojos.PickPendingItemDTO;
...
public class PendingSlocToSlocListFragmentHU extends Fragment implements View.OnClickListener {

    private static final String classCode = "API_FRAG_PendingSlocToSlocListFragmentHU";
    private View rootView;

    private Button btnCancel;
    private RecyclerView rvPendingPickItemList;
    ...
    private String clientId = null, inboundId = null, VlpdId = null;
    List<OutboundDTO> lstOutbound = null;
    private String userId = null;
    private String storeRefNo = null;
    private String loc = null, sku = null, desc = null, reqQty = null, balQty = null, barcode = null, pallet = null, qty = null, Referenceno = null, Box = null, dock = null, batchno, vlpdId = null, CaseNo = null;
    Bundle bundle;
    public ItemInfoDTO vlpdItem;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (NetworkUtils.isInternetAvailable(getContext())) {
            rootView = inflater.inflate(R.layout.fragment_pending_pickitemlist, container, false);
            loadFormControls();
        } else {
    ...
    public void loadFormControls() {
        ...
        rvPendingPickItemList = (RecyclerView) rootView.findViewById(R.id.rvPendingPickItemList);
        rvPendingPickItemList.setHasFixedSize(true);

        linearLayoutManager = new LinearLayoutManager(getContext());

        // use a linear layout manager
        rvPendingPickItemList.setLayoutManager(linearLayoutManager);
        ...
        if (getArguments() != null) {
            ...
            if (getArguments() != null) {
                ...
                if (materialType.equals("HU")) {
                    ...
                    Referenceno = getArguments().getString("vlpdNo");
    ...
    public void goBack() {
        ...
        if (materialType == "HU") {
            ...
            bundle.putString("vlpdNo", Referenceno);
            ...
            SLocToSLocFragment sLocToSLocFragment = new SLocToSLocFragment();
            sLocToSLocFragment.setArguments(bundle);
            FragmentUtils.replaceFragmentWithBackStack(getActivity(), R.id.container_body, sLocToSLocFragment);
            return;
        } else {
            ...
            SLocToSLocFragmentHH sLocToSLocFragmentHH = new SLocToSLocFragmentHH();
            sLocToSLocFragmentHH.setArguments(bundle);
            FragmentUtils.replaceFragmentWithBackStack(getActivity(), R.id.container_body, sLocToSLocFragmentHH);
            return;
        }
    }
                    ...
                    public void onResponse(Call<String> call, Response<String> response) {
                        ...
                        try {
                            ...
                            if (core.getType() != null) {
                                ...
                                rvPendingPickItemList.setAdapter(pendingOutboundListAdapter);
                                ProgressDialogUtils.closeProgressDialog();
