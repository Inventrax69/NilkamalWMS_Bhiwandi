...
public class PendingOutboundListAdapter  extends RecyclerView.Adapter {

    private List<PickPendingItemDTO> pendingOutboundList;

    Context context;
    public PendingOutboundListAdapter(Context context, List<PickPendingItemDTO> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.pending_outbound_row, parent, false);
