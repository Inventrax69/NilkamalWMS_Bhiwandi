package com.inventrax.nilkamal_biwandhi.adapters;
...
public class PendingPickOnDemandHUAdpater extends RecyclerView.Adapter {

    private List<PickPendingItemDTO> pendingOutboundList;

    Context context;
    public PendingPickOnDemandHUAdpater(Context context, List<PickPendingItemDTO> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.pending_pickondemand_row_hu, parent, false);
